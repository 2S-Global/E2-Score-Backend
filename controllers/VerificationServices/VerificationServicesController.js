...
export const VerificationServices = async (req, res) => {
  ...
  try {
    ...
    return apiResponse(
      ...
      200,
      true,
      "Verification service created successfully",
      response,
    );
  } catch (error) {
...
export const UpdateVerificationServices = async (req, res) => {
  ...
  const { title, icon, backgroundColor, description, iconColor } = req.body;
  try {
    const response = await VerificationServicesModel.findByIdAndUpdate(
      _id,
      {
        $set: {
          title,
    ...
    if (!response) {
      return apiResponse(
        ...
        400,
        false,
        "Failed to update verification service",
      );
    }
    ...
    return apiResponse(
      ...
      200,
      true,
      "Verification service updated successfully",
      response,
    );
  } catch (error) {
    return apiResponse(res, 500, false, "Internal server error", error);
  ...
  try {
    ...
    if (!response) {
      return apiResponse(
        ...
        400,
        false,
        "Failed to delete verification service",
      );
    }
    ...
    return apiResponse(
      ...
      200,
      true,
      "Verification service deleted successfully",
      response,
    );
  } catch (error) {
    return apiResponse(res, 500, false, "Internal server error", error);
  ...
  try {
    ...
    if (!response) {
      return apiResponse(
        ...
        404,
        false,
        "No verification services found",
        null,
      );
    }
    ...
    return apiResponse(
      ...
      200,
      true,
      "Verification services fetched successfully",
      response,
    );
  } catch (error) {
    return apiResponse(res, 500, false, "Internal server error", error);
