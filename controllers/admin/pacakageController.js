...
/**
 * @description Create the new packages and add to database
 * @route GET /api/pacakageRoute/addPackage
 * @success {object} 201 - Saved Package SUccessfully aling with the details
 ...
 * @route GET /api/pacakageRoute/getAllPackages
...
/**
 * @description Delete any perticular Package
 * @route GET /api/pacakageRoute/deletePackage
...
/**
 * @description It allows to update any perticular package
 * @route GET /api/pacakageRoute/updatePackage
...
/**
 * @description It allows to enable and disable any package without going to edit page
 * @route GET /api/pacakageRoute/toggleStatusPackage
 * @success {object} 200 - after a successful update return the updated data
 * @error {object} 500 - Error Occured in Database query failed
 */
