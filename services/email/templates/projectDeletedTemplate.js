export const projectDeletedTemplate = (userName) => `
<div style="font-family: Arial, sans-serif; color:#333; padding:20px; line-height:1.6; max-width:600px; margin:auto; background:#f9f9f9; border-radius:8px;">
  ...
  <div>
    <img
      src="${process.env.CLIENT_BASE_URL_TEMP}/images/emailheader/deleteprojects.png"
      alt="GEISIL Banner"
  ...
  <div style="padding:20px; background:#ffffff; border-radius:0 0 8px 8px;">
    ...
    <p>
      One of your project details has been <strong>Deleted</strong> from your profile.
    </p>
    ...
    <p>
      <a href="${process.env.ORIGIN}" style="color:#0052cc;">
        ${process.env.ORIGIN}
      </a>
    </p>
