...
import { cibilScoreHandler } from "./actions/cibilScoreHandler.js";
import { experianScoreHandler } from "./actions/experianScoreHandler.js";
...
export const emailHandlers = {
  ...
  institute_student_import_credentials:
    instituteStudentImportCredentialsHandler,
  institute_student_profile_completion:
    instituteStudentProfileCompletionHandler,
  institute_interview_invitation: instituteInterviewInvitationHandler,
  institute_recruiter_interview_schedule:
    instituteRecruiterInterviewScheduleHandler,
  institute_academic_verification_status:
    instituteAcademicVerificationStatusHandler,
  company_employment_verification_status:
    companyEmploymentVerificationStatusHandler,
  ...
  company_interview_reschedule_request:
    companyInterviewRescheduleRequestHandler,
  user_credentials_email: userCredentialsHandler,
  cover_letter_uploaded: coverLetterUploadedHandler,
  latest_CIBIL_score: cibilScoreHandler,
  latest_experian_score: experianScoreHandler,
};
